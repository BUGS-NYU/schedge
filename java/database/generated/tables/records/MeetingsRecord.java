...
public class MeetingsRecord extends UpdatableRecordImpl<MeetingsRecord> implements Record6<Integer, Integer, String, Timestamp, Timestamp, Long> {

    private static final long serialVersionUID = -1546889364;
     ...
     */
    @Override
    public Row6<Integer, Integer, String, Timestamp, Timestamp, Long> fieldsRow() {
     ...
     */
    @Override
    public Row6<Integer, Integer, String, Timestamp, Timestamp, Long> valuesRow() {
     ...
     */
    @Override
    public MeetingsRecord values(Integer value1, Integer value2, String value3, Timestamp value4, Timestamp value5, Long value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MeetingsRecord(Integer id, Integer sectionId, String location, Timestamp beginDate, Timestamp endDate, Long duration) {
        super(Meetings.MEETINGS);
