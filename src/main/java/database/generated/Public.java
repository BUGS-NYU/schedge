...
public class Public extends SchemaImpl {
   ...
   */
  private Public() { super("public", null); }
  ...
  private final List<Sequence<?>> getSequences0() {
    return Arrays.<Sequence<?>>asList(Sequences.COURSES_ID_SEQ,
  ...
  private final List<Table<?>> getTables0() {
    return Arrays.<Table<?>>asList(Courses.COURSES,
                                   FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY,
                                   Meetings.MEETINGS, Sections.SECTIONS);
  }
}
