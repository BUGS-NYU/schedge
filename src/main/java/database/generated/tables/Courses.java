...
public class Courses extends TableImpl<CoursesRecord> {
   ...
   */
  public final TableField<CoursesRecord, Integer> ID = createField(
      "id",
      org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('courses_id_seq'::regclass)",
   ...
   */
  public final TableField<CoursesRecord, String> NAME = createField(
      "name", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");

  /**
   * The column <code>public.courses.school</code>.
   */
  public final TableField<CoursesRecord, String> SCHOOL = createField(
      "school", org.jooq.impl.SQLDataType.VARCHAR(4).nullable(false), this, "");

  /**
   * The column <code>public.courses.subject</code>.
   */
  public final TableField<CoursesRecord, String> SUBJECT = createField(
      "subject", org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false), this,
      "");

  /**
   * The column <code>public.courses.dept_course_id</code>.
   */
  public final TableField<CoursesRecord, String> DEPT_COURSE_ID = createField(
      "dept_course_id", org.jooq.impl.SQLDataType.VARCHAR(6).nullable(false),
      this, "");

  /**
   * The column <code>public.courses.term_id</code>.
   */
  public final TableField<CoursesRecord, Integer> TERM_ID = createField(
      "term_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

  /**
   * Create a <code>public.courses</code> table reference
   */
  public Courses() { this(DSL.name("courses"), null); }

  /**
   * Create an aliased <code>public.courses</code> table reference
   */
  public Courses(String alias) { this(DSL.name(alias), COURSES); }

  /**
   * Create an aliased <code>public.courses</code> table reference
   */
  public Courses(Name alias) { this(alias, COURSES); }
  ...
  public <O extends Record> Courses(Table<O> child,
                                    ForeignKey<O, CoursesRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.COURSE_IDX, Indexes.COURSES_ID_KEY,
                                Indexes.COURSES_PKEY);
  }
  ...
  public List<UniqueKey<CoursesRecord>> getKeys() {
    return Arrays.<UniqueKey<CoursesRecord>>asList(Keys.COURSES_ID_KEY,
                                                   Keys.COURSES_PKEY);
  }
