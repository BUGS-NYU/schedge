...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
   ...
   */
  public final TableField<FlywaySchemaHistoryRecord, String> TYPE = createField(
      "type", org.jooq.impl.SQLDataType.VARCHAR(20).nullable(false), this, "");
  ...
  public final TableField<FlywaySchemaHistoryRecord, Timestamp> INSTALLED_ON =
      createField(
          "installed_on",
          org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(
              org.jooq.impl.DSL.field("now()",
  ...
  public final TableField<FlywaySchemaHistoryRecord, Boolean> SUCCESS =
      createField("success", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false),
                  this, "");
   ...
   * Create an aliased <code>public.flyway_schema_history</code> table reference
   */
  public FlywaySchemaHistory(Name alias) { this(alias, FLYWAY_SCHEMA_HISTORY); }

  private FlywaySchemaHistory(Name alias,
  ...
  FlywaySchemaHistory(Table<O> child,
                      ForeignKey<O, FlywaySchemaHistoryRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.FLYWAY_SCHEMA_HISTORY_PK,
                                Indexes.FLYWAY_SCHEMA_HISTORY_S_IDX);
  }
