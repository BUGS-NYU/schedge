...
public class FlywaySchemaHistoryRecord
    extends UpdatableRecordImpl<FlywaySchemaHistoryRecord>
    implements Record10<Integer, String, String, String, String, Integer,
                        String, Timestamp, Integer, Boolean> {

  private static final long serialVersionUID = 1662583382;
   ...
   */
  public Integer getInstalledRank() { return (Integer)get(0); }
   ...
   */
  public String getVersion() { return (String)get(1); }
   ...
   */
  public String getType() { return (String)get(3); }
   ...
   */
  public String getScript() { return (String)get(4); }
   ...
   */
  public Integer getChecksum() { return (Integer)get(5); }
   ...
   */
  public String getInstalledBy() { return (String)get(6); }
   ...
   */
  public Timestamp getInstalledOn() { return (Timestamp)get(7); }
   ...
   */
  public Integer getExecutionTime() { return (Integer)get(8); }
   ...
   */
  public Boolean getSuccess() { return (Boolean)get(9); }
   ...
   */
  @Override
  public Row10<Integer, String, String, String, String, Integer, String,
  ...
  values(Integer value1, String value2, String value3, String value4,
         String value5, Integer value6, String value7, Timestamp value8,
         Integer value9, Boolean value10) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
   ...
   */
  public FlywaySchemaHistoryRecord(Integer installedRank, String version,
