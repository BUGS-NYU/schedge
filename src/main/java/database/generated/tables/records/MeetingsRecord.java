...
public class MeetingsRecord extends UpdatableRecordImpl<MeetingsRecord>
    implements Record5<Integer, Integer, Timestamp, Timestamp, Long> {
   ...
   */
  public Integer getSectionId() { return (Integer)get(1); }
   ...
   */
  public Timestamp getBeginDate() { return (Timestamp)get(2); }
   ...
   */
  public Timestamp getEndDate() { return (Timestamp)get(3); }
   ...
   */
  public Long getDuration() { return (Long)get(4); }
   ...
   */
  public MeetingsRecord() { super(Meetings.MEETINGS); }

  /**
   * Create a detached, initialised MeetingsRecord
   */
  public MeetingsRecord(Integer id, Integer sectionId, Timestamp beginDate,
