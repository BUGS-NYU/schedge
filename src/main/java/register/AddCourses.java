...
public class AddCourses {
  ...
  //            Term term, int registrationNumber, Context.HttpContext
  //            preContext) {
  //        List<Cookie> cookies = Login.getLoginSession(username, password,
  //        preContext); System.out.println(cookies.toString()); Request request
  //        =
  //                new RequestBuilder()
