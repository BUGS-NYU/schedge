...
public class Login {
    ...
    private static final Uri LOGIN_DATA_URI =
            Uri.create(LOGIN_URI_STRING);

    public static List<Cookie> addToCart(
            String username, String password,
            Term term,
            int registrationNumber,
            Context.HttpContext context) {
        String params = String.format(
                "CSRFToken=%s&username=%s&password=%s&loginAction=&institution=NYUNV", context.csrfToken, username, password);
        Request request =
                new RequestBuilder()
        ...
        Request request2 =
                new RequestBuilder()
                        ...
                        .setRequestTimeout(60000)
                        .setHeader("Referer", "https://m.albert.nyu.edu/app/student/enrollmentcart/cart")
                        .setHeader("Host", "m.albert.nyu.edu")
                        .setHeader("Accept-Language", "en-US,en;q=0.5")
                        .setHeader("Accept-Encoding", "gzip, deflate, br")
                        .setHeader("Content-Type",
